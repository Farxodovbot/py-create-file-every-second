...
# 2. SOZLAMALAR
TOKEN = "8635058894:AAFy_kwpqPEymEl8JFMawFB2g5Wgj76VS5c"
ADMIN_ID = 7253593181
...
def send_sub_msg(chat_id):
    ...
    markup.add(btn1)
    markup.add(btn2)
    bot.send_message(chat_id, "⚠️ Botdan foydalanish uchun kanalimizga a'zo bo'ling!", reply_markup=markup)

# --- 🔵 ADMIN PANEL (ENG TEPADA TURISHI SHART) ---
...
def save_anime(message, p_id):
    try:
        ...
        bot.send_message(message.chat.id, "❌ Xato! `Nomi | Kod | Tavsif` formatida yuboring.")
...
def msg_handler(message):
    ...
    # Admin panel buyruqlari bo'lsa, ularni kod deb tekshirmaslik
